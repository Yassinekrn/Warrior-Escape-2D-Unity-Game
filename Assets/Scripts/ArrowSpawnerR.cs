...
public class ArrowSpawnerR : MonoBehaviour
{
    ...
    IEnumerator RotateArrow(GameObject arrow)
    {
        ...
        Quaternion startRotation = Quaternion.Euler(0f, 0f, 180f); // The arrow's initial rotation
        Quaternion targetRotation = Quaternion.Euler(0f, 0f, -90f); // The target rotation for the arrow
